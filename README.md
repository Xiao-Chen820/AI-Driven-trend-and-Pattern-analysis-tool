...
e.g., docker run -it --shm-size=100gb -v /home/xchen/data:/home/xchen/data --name postgis_xchen -p 5432:5432 -t postgis2:latest
...
![image](https://github.com/user-attachments/assets/66a3f014-24a9-4413-bbf2-7bb487712127)
